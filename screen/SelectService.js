...
import { View, StyleSheet, FlatList, Text, SafeAreaView, TextInput } from "react-native";
...
<FlatList
          ...
          renderItem={({ item,index }) => (
            <Button
              ...
              style={[
                styles.button,
                selectedButton === item.c_deliveryTypeID &&
                  styles.selectedButton,
                 
              ]}
              color={selectedButton === item.c_deliveryTypeID ? 'white' : undefined}
              onPress={() => {
    ...
    <Button title="Next" onPress={()=>navigation.navigate('ReviewOrder', {
      dates:dates,
      notes:notes
    })}/>
  </SafeAreaView>
